...
/*users*/
insert into _user (id, biography, city, country, email, firstname, imageurl, instagramname, ismodel, isphotographer, lastname, username, websiteurl, password)
values (100, 'photographer without regrets', 'Linz', 'Austria', 'ltea@mail.com', 'Leon', 'https://scontent-vie1-1.cdninstagram.com/v/t51.2885-19/s320x320/124188864_879588679243345_2016517700226628149_n.jpg?tp=1&_nc_ht=scontent-vie1-1.cdninstagram.com&_nc_ohc=hsY39r4TEOMAX9acdj8&ccb=7-4&oh=b2d269088fea6b9688d1f60fac850f8e&oe=607D3727', 'leon.tea', false, true, 'Tea', 'leonn', 'www.google.com', 'passme');

insert into _user (id, biography, city, country, email, firstname, imageurl, instagramname, ismodel, isphotographer, lastname, username, websiteurl, password)
values (101, '📷 | 🌍 | 🇦🇹 | 📍 Linz ✉️ DM for photoshooting', 'Linz', 'Austria', 'fran@mail.com', 'Francis', 'https://scontent-vie1-1.cdninstagram.com/v/t51.2885-19/s320x320/121616104_1772376002918196_6595898946490198361_n.jpg?tp=1&_nc_ht=scontent-vie1-1.cdninstagram.com&_nc_ohc=zTm9_ObQVp0AX9PYwyK&ccb=7-4&oh=3ddde37c38657078bc2927a83c2ca720&oe=607CA03D', 'francis_liger', false, true, 'Ehmeir', 'franciss', 'www.google.com', 'passme');

insert into _user (id, biography, city, country, email, firstname, imageurl, instagramname, ismodel, isphotographer, lastname, username, websiteurl, password)
values (102, '🦄', 'Linz', 'Austria', 'loo@mail.com', 'Lorenz', 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png', 'l.0o0o0', false, true, 'Gruber', 'Loo', 'www.google.com', 'passme');
...
insert into _user (id, biography, city, country, email, firstname, imageurl, instagramname, ismodel, isphotographer, lastname, username, websiteurl, password)
values (104, '', 'Linz', 'Austria', 'hope@mail.com', 'Hope', 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png', 'hope_snr', true, false, 'Senegal', 'Hopee', 'www.google.com', 'passme');
