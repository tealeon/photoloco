...
values ('100', 'just_leon', 'Leon', 'Tea', 'leon.tea@mail.com', 'https://bit.ly/2IbzVy3', 'Linz', 'Austria', 'false',
        'true', 'bloody beginner');
insert into usr(usr_id, usr_name, usr_fname, usr_lname, usr_email, usr_img, usr_city, usr_country, usr_is_model,
                usr_is_photographer, usr_biography)
...
values (100, 'This is my very first Post! I am so happy rn', 'https://bit.ly/2L2mi5m', 'a random pic', '2020-09-01',
        100);
insert into post(post_id, post_description, post_img_url, post_title, post_upload_date, post_usr_id)
values (101, 'This is my second Post! I am so sad rn', 'https://bit.ly/2JRdPkO', 'idk what i did TT', '2020-09-04',
        100);
insert into post(post_id, post_description, post_img_url, post_title, post_upload_date, post_usr_id)
values (102, 'who is this girl 👀', 'https://bit.ly/2VGnC04', 'T R A P P E D', '2020-09-09', 100);
insert into post(post_id, post_description, post_img_url, post_title, post_upload_date, post_usr_id)
values (103, 'what am i even doing...', 'https://bit.ly/3otKEDo', 'not my brother', '2020-09-09', 100);
insert into post(post_id, post_description, post_img_url, post_title, post_upload_date, post_usr_id)
