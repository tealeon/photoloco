...
values (1, 48.30639, 14.28611, 'Linz');
insert into location(id, longitude, latitude, name)
values (2, 48.210033, 16.363449, 'Wien');
insert into location(id, longitude, latitude, name)
values (3, 47.076668, 15.421371, 'Graz');
insert into location(id, longitude, latitude, name)
values (4, 48.27965, 14.2533, 'Leonding');
insert into location(id, longitude, latitude, name)
values (5, 48.20969, 14.29004, 'Ansfelden');
insert into location(id, longitude, latitude, name)
values (6, 47.79941, 13.04399, 'Salzburg');
insert into location(id, longitude, latitude, name)
values (7, 47.26266, 11.39454, 'Innsbruck');
insert into location(id, longitude, latitude, name)
values (8, 48.25628, 13.04343, 'Braunau am Inn');
